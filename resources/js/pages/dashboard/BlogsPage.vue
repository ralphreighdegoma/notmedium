<template>
  <q-page padding>
    <div class="q-pa-md">
      ...
      <q-dialog v-model="showAddBlogModal" persistent>
        <add-blog-modal @close="showAddBlogModal = false" @blog-added="refreshBlogs" />
      </q-dialog>

      <q-dialog v-model="showEditBlogModal" persistent>
        <edit-blog-modal 
          :blog="selectedBlog" 
...
import AddBlogModal from '../../components/blogs/AddBlogModal.vue';
import EditBlogModal from '../../components/blogs/EditBlogModal.vue';
...
const previewBlog = (blog) => {
  window.open(`/blog/${slugify(blog.title)}/preview`, '_blank');
};
